...
const CheckoutPage: React.FC = () => {
  ...
  const handleRemoveItem = (id: string, itemName: string) => {
    const confirmRemoval = window.confirm(`Deseja realmente excluir "${itemName}" do seu pedido?`);
    if (confirmRemoval) {
    ...
    return (
      <div className="flex items-start bg-[#F2E8CF] p-4 rounded-4xl mb-4 relative">
        ...
        <div className="flex-grow">
          ...
          <p className="text-sm text-gray-500 mt-1">Previsão de Entrega: {item.deliveryDateRange}</p>
          <div className="flex items-center mt-3">
            ...
            <div className="flex items-center bg-[#A7C957] rounded-full p-1 mr-4">
              ...
              <span className="mx-3 text-lg font-semibold text-[#386641]">{item.quantity}</span>
              <button
  ...
  return (
    <div className="min-h-screen bg-[#3E6F52] p-4 md:p-8 flex flex-col items-center">
      {/* Título da Página */}
      <h1 className="w-full max-w-7xl text-4xl font-bold text-[#A7C957] mb-8 self-start">Finalizar Compra</h1>
      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          <div className="bg-[#F2E8CF] p-6 rounded-4xl">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-[#386641]">Método de Pagamento</h2>
              <button className="bg-transparent text-[#6CAF4B] border border-[#6CAF4B] py-2 px-4 rounded-full text-sm font-semibold hover:bg-[#A7C957] hover:text-[#386641] transition-colors duration-300">
                Mudar Pagamento
              </button>
            </div>
        ...
        <div className="lg:w-96 bg-[#F2E8CF] p-6 rounded-4xl self-start sticky top-8">
          <div className="mb-6">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="font-semibold text-[#E53E3E]">- R$ {discountsApplied.toFixed(2).replace('.', ',')}</span>
            </div>
