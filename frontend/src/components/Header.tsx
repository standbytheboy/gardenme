...
export const Header = () => {
  ...
  return (
    <div className="bg-[#386641] py-20 px-20">
      <section className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between gap-10 lg:gap-20 font-sans bg-[#386641] pt-16 pb-12 px-6 lg:px-20 rounded-bl-[3rem] rounded-br-[3rem]">
