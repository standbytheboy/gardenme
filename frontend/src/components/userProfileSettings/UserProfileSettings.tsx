      ...
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-7xl h-[95vh] rounded-lg overflow-hidden">
        ...
        <div className="flex-1 bg-[#344E41] p-15 rounded-lg shadow-lg overflow-auto flex flex-col justify-center">
          ...
          {activeMenuItem === 'Notificações' && (
            <div className="text-lg text-white">Configurações de Notificações...</div>
          )}
          {activeMenuItem === 'Excluir conta' && (
            <div className="text-lg text-red-500">Opções para Excluir Conta...</div>
          )}
          {activeMenuItem === 'Suporte' && (
            <div className="text-lg text-white">Entre em Contato com o Suporte...</div>
          )}
        </div>
      </div>
    </div>
