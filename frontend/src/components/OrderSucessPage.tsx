...
const OrderSuccessPage: React.FC<OrderSuccessPageProps> = ({ orderNumber = '12345' }) => {
  ...
  return (
    <div className="min-h-screen bg-[#344E41] text-center flex flex-col items-center justify-center p-4 md:p-8">
      ...
      <p className="text-lg md:text-xl text-[#D4EDC8] max-w-3xl leading-relaxed mb-12">
        Agradecemos a sua compra! Seu pedido #<span className="font-semibold">{orderNumber}</span> foi confirmado e está sendo
        preparado com todo carinho. Em breve, a natureza estará batendo à sua porta.
      </p>
      ...
      <p className="text-md md:text-lg text-[#D4EDC8] max-w-3xl leading-relaxed mb-10">
        Você receberá um e-mail com os detalhes e o acompanhamento da entrega. Enquanto isso,
        explore mais plantas ou prepare o cantinho da sua nova amiga verde!
      </p>
